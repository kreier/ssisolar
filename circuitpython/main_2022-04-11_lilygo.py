...
# SSIS adaptation: @emwdx and @kreier 2022-04-11
...
while True:
    ...
    if (time.monotonic() - last) >= 20:
        input_current = get_voltage(input_voltage_1) * 3 # the current over 0.5 Ohm as voltage
        ...
        input_voltage = get_voltage(input_voltage_2) - (input_current / ( 5.1))
        # the solar voltage divided by 5.7
        print("Published {0} and {1}.".format(input_current,input_voltage))
        print(gc.mem_free())
